...
{
    /**
     * A Grip subclass for manipulating a path item
     */
    public class PathPointGrip : Grip
    {
        /**
         ...
         * @param command_index The index of the path command
         * @param point_index The index of the point
         */
        public PathPointGrip(
        ...
        /**
         * The index of the command to manipulate
         */
