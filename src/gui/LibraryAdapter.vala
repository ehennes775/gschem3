    ...
    public class LibraryAdapter : Object, Gtk.TreeModel
    {
        ...
        static construct
        {
            ...
            s_icons[Geda3.ProjectIcon.RED_FOLDER] = new Gdk.Pixbuf.from_resource(
                "/com/github/ehennes775/gschem3/gui/img/RedFolder.svg"
                );
                
            s_icons[Geda3.ProjectIcon.GREEN_FOLDER] = new Gdk.Pixbuf.from_resource(
                "/com/github/ehennes775/gschem3/gui/img/GreenFolder.svg"
                );
                
            s_icons[Geda3.ProjectIcon.PLUM_FOLDER] = new Gdk.Pixbuf.from_resource(
                "/com/github/ehennes775/gschem3/gui/img/PlumFolder.svg"
                );
                
            s_icons[Geda3.ProjectIcon.YELLOW_FOLDER] = new Gdk.Pixbuf.from_resource(
                "/com/github/ehennes775/gschem3/gui/img/YellowFolder.svg"
                );
        }
